...
public:
    ...
    /**
    * This copy construct function can make the difference type to be the type that this class type needs
    */
    ...
    /**
    * This assignment construct function can make the difference type to be the type that this class type needs
    */
    template <class U1, class U2>
