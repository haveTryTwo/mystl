#ifndef MY_STL_NUMERIC_H
#define MY_STL_NUMERIC_H
...
OutputIterator __my_adjacent_difference(InputIterator first, InputIterator last, OutputIterator result, T*)
{
    T value = *first;
    while (++first != last)
    {
...
OutputIterator __my_adjacent_difference(InputIterator first, InputIterator last, OutputIterator result,
...
template <class InputIterator, class OutputIterator, class BinaryOperation>
OutputIterator my_partial_sum(InputIterator first, InputIterator last, OutputIterator result, BinaryOperation binary_op)
{
    if (first == last)
    {
        return result;
