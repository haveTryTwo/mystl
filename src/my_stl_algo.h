#ifndef MY_STL_ALGO_H
#define MY_STL_ALGO_H
 ...
 **************************************/
template <class InputIterator, class Predicate>
InputIterator my_find_if(InputIterator first, InputIterator last,
                         Predicate pred)
{
...
inline ForwardIterator1 my_search(ForwardIterator1 first1, ForwardIterator1 last1,
                                  ...
                                  Compare comp)
{
    return __my_search(first1, last1, first2, last2, distance_type(first1), distance_type(first2), comp);
}

template <class ForwardIterator1, class ForwardIterator2, class Distance1, class Distance2, class Compare>
ForwardIterator1 __my_search(ForwardIterator1 first1, ForwardIterator1 last1,
                             ForwardIterator2 first2, ForwardIterator2 last2,
                             Distance1*, Distance2*,
                             Compare comp)
...
InputIterator my_find_first_of(InputIterator first1, InputIterator last1,
...
bool my_includes(InputIterator1 first1, InputIterator1 last1,
                 InputIterator2 first2, InputIterator2 last2)
{
    while (first1 != last1 && first2 != last2)
    {
...
ForwardIterator my_remove(ForwardIterator first, ForwardIterator last,
                          const T& value)
{
...
OutputIterator my_remove_copy(InputIterator first, InputIterator last,
                              OutputIterator result,
                              const T& value)
{
    for (; first != last; ++first)
...
OutputIterator my_remove_copy_if(InputIterator first, InputIterator last,
                                 OutputIterator result,
                                 Predicate pred)
{
    for (; first != last; ++first)
...
template <class InputIterator, class OutputIterator, class T>
OutputIterator my_replace_copy(InputIterator first, InputIterator last,
...
OutputIterator my_replace_copy_if(Iterator first, Iterator last,
...
void __my_reverse(RandomAccessIterator first, RandomAccessIterator last, my_random_access_iterator_tag)
{
    while (first < last)
    {
        my_iter_swap(first++, --last);
...
OutputIterator my_reverse_copy(BidirectionalIterator first, BidirectionalIterator last, OutputIterator result)
{
    while (first != last)
    {
        --last;
...
void __my_rotate(ForwardIterator first, ForwardIterator middle, ForwardIterator last, Distance*, my_forward_iterator_tag)
{
...
void __my_rotate(BidirectionalIterator first, BidirectionalIterator middle, BidirectionalIterator last,
                 Distance*, my_bidirectional_iterator_tag)
{
...
void __my_rotate_cycle(RandomAccessIterator first, RandomAccessIterator last, RandomAccessIterator initial,
                       Distance shift, T*)
{
    T value = *initial;
...
OutputIterator my_rotate_copy(ForwardIterator first, ForwardIterator middle, ForwardIterator last, OutputIterator result)
{
...
ForwardIterator my_search_n(ForwardIterator first, ForwardIterator last, Integer count, const T& value)
{
    if (count < 0)
    {
        return first;
...
OutputIterator my_transform(InputIterator first, InputIterator last,
...
template <class InputIterator, class ForwardIterator>
ForwardIterator __my_unique_copy(InputIterator first, InputIterator last,
                                 ForwardIterator result, my_forward_iterator_tag)
{
    *result = *first;
    while (++first != last)
    {
...
template <class InputIterator, class OutputIterator, class T>
OutputIterator __my_unique_copy(InputIterator first, InputIterator last,
...
ForwardIterator __my_unique_copy(InputIterator first, InputIterator last,
                                 ForwardIterator result, my_forward_iterator_tag, BinaryOperation binary_op)
{
    *result = *first;
    while (++first != last)
    {
...
template <class InputIterator, class OutputIterator, class BinaryOperation>
inline OutputIterator __my_unique_copy(InputIterator first, InputIterator last,
                                       OutputIterator result, my_output_iterator_tag, BinaryOperation binary_op)
{
