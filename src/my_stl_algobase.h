...
inline bool my_equal(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, BinaryPredicate binary_pred)
{
    for (; first1 != last1; ++first1)
    {
...
inline bool my_lexicographical_compare(const unsigned char* first1,
...
inline bool my_lexicographical_compare(const char* first1,
                                       const char* last1,
                                       const char* first2,
                                       const char* last2)
{
...
template <class InputIterator, class OutputIterator>
inline OutputIterator __my_copy(InputIterator first, InputIterator last, OutputIterator result, my_input_iterator_tag)
{
    bool contains = false;
...
inline OutputIterator __my_copy(RandomAccessIterator first, RandomAccessIterator last, OutputIterator result, 
...
inline OutputIterator __my_copy_d(RandomAccessIterator first, RandomAccessIterator last, OutputIterator result,
        Distance*)
{
...
template <class BidirectionalIterator1, class BidirectionalIterator2>
inline BidirectionalIterator2 my_copy_backward(BidirectionalIterator1 first, BidirectionalIterator1 last,
        BidirectionalIterator2 result)
{
    return __my_copy_backward_dispatch<BidirectionalIterator1, BidirectionalIterator2>()
           (first, last, result);
}
 ...
 */
template <class BidirectionalIterator1, class BidirectionalIterator2>
inline BidirectionalIterator2 __my_copy_backward(BidirectionalIterator1 first, BidirectionalIterator1 last,
        BidirectionalIterator2 result, my_bidirectional_iterator_tag)
{
...
inline RandomAccessIterator2 __my_copy_backward(RandomAccessIterator1 first, RandomAccessIterator1 last,
        RandomAccessIterator2 result, my_random_access_iterator_tag)
{
...
inline RandomAccessIterator2 __my_copy_backward_d(RandomAccessIterator1 first, RandomAccessIterator1 last,
        RandomAccessIterator2 result, Distance* d)
{
    ...
    {
        // if the start of result is in the range of first and last, then deal with this according to the function
...
inline ForwardIterator my_lower_bound(ForwardIterator first, ForwardIterator last, const T& value, Compare comp)
{
    return __my_lower_bound(first, last, value, comp, distance_type(first), iterator_category(first));
}

template <class ForwardIterator, class T, class Distance>
ForwardIterator __my_lower_bound(ForwardIterator first, ForwardIterator last, const T& value, Distance*, 			  		                	my_forward_iterator_tag)
{
    Distance len = 0;
...
ForwardIterator __my_lower_bound(ForwardIterator first, ForwardIterator last, const T& value, Compare comp,
...
RandomAccessIterator __my_lower_bound(RandomAccessIterator first, RandomAccessIterator last,
                                      const T& value, Compare comp, Distance*, my_random_access_iterator_tag)
{
    Distance len = last - first;
    Distance half;
    RandomAccessIterator middle;
...
template <class ForwardIterator, class T, class Compare, class Distance>
ForwardIterator __my_upper_bound(ForwardIterator first, ForwardIterator last, const T& value, Compare comp,
                                 Distance*, my_forward_iterator_tag)
{
    Distance len = 0;
    len = my_distance(first, last);
...
inline void my_partial_sort(RandomAccessIterator first, RandomAccessIterator middle, RandomAccessIterator last)
{
    __my_partial_sort(first, middle, last, value_type(first));
}

template <class RandomAccessIterator, class T>
void __my_partial_sort(RandomAccessIterator first, RandomAccessIterator middle, RandomAccessIterator last, T*)
{
 ...
 ********************************/
template <class RandomAccessIterator, class T>
RandomAccessIterator __my_unguarded_partition(RandomAccessIterator first, RandomAccessIterator last, T pivot)
{
    while (true)
    {
        while (*first < pivot)
...
void __my_introsort_loop(RandomAccessIterator first, RandomAccessIterator last, T*, Size depth_limit)
{
    while (last - first > __my_stl_threshold)
    {
        ...
        --depth_limit;
        // quick sort
        RandomAccessIterator cur = __my_unguarded_partition(first, last,
                                   T(__my_median(*first, *(first + (last - first) / 2), *(last - 1))));
...
template <class RandomAccessIterator, class T>
inline void __my_unguarded_insertion_sort_aux(RandomAccessIterator first, RandomAccessIterator last, T*)
{
 ...
 ********************************/
template <class ForwardIterator, class T>
inline my_pair<ForwardIterator, ForwardIterator> my_equal_range(ForwardIterator first, ForwardIterator last,
        const T& value)
{
...
template <class RandomAccessIterator, class T, class Distance>
my_pair<RandomAccessIterator, RandomAccessIterator> __my_equal_range(RandomAccessIterator first,
        RandomAccessIterator last, const T& value, Distance*, my_random_access_iterator_tag)
{
    Distance len = last - first;
    Distance half;
...
my_pair<ForwardIterator, ForwardIterator> __my_equal_range(ForwardIterator first,
        ForwardIterator last, const T& value, Distance*, my_forward_iterator_tag)
{
    Distance len = 0;
    len = my_distance(first, last);
    Distance half;
 ...
 ********************************/
template <class RandomAccessIterator>
inline void my_nth_element(RandomAccessIterator first, RandomAccessIterator nth, RandomAccessIterator last)
{
    __my_nth_element(first, nth, last, value_type(first));
}

template <class RandomAccessIterator, class T>
void __my_nth_element(RandomAccessIterator first, RandomAccessIterator nth, RandomAccessIterator last, T*)
{
    while (last - first > 3)
    {
        RandomAccessIterator cut = __my_unguarded_partition(first, last, T(__my_median(*first,
...
template <class RandomAccessIterator, class T, class Compare>
void __my_nth_element(RandomAccessIterator first, RandomAccessIterator nth, RandomAccessIterator last,
                      T*, Compare comp)
{
    while (last - first > 3)
    {
