#ifndef MY_DEFAULT_STL_ALLOC
#define MY_DEFAULT_STL_ALLOC
...
template <bool threads, int inst>
typename __my_default_alloc_template<threads, inst> :: obj *	volatile
__my_default_alloc_template<threads, inst> ::free_list[__NFREELISTS] =
...
template <bool threads, int inst>
void* __my_default_alloc_template<threads, inst> ::reallocate(void *p, size_t old_sz, size_t new_sz)
{
    obj * volatile * my_free_list;
    obj * result;
