 ...
 * hashtable_iterator
 ***********************************************************************/
template <class Value, class Key, class Ref, class Pointer, class HashFun, class ExtractKey, class EqualKey, class Alloc>
class __my_hashtable_iterator
{
public:
    typedef my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc> hashtable;
    typedef __my_hashtable_iterator<Value, Key, Ref, Pointer, HashFun, ExtractKey, EqualKey, Alloc> iterator;
//	typedef __my_hashtable_iterator<Value, Key, const Ref, const Pointer, HashFun, ExtractKey, EqualKey, Alloc> 									const_iterator;
...
public:
    ...
    hashtable* ht; // keep the relation of containter if the situation that from one bucket to another bucket
...
template <class Value, class Key, class Ref, class Pointer, class HashFun, class ExtractKey, class EqualKey, class Alloc>
__my_hashtable_iterator<Value, Key, Ref, Pointer, HashFun, ExtractKey, EqualKey, Alloc>
__my_hashtable_iterator<Value, Key, Ref, Pointer, HashFun, ExtractKey, EqualKey, Alloc>::operator++(int)
{
    iterator tmp = *this;
    ++*this;
    return tmp;
 ...
 * hashtable
 ***********************************************************************/
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc = my_alloc>
class my_hashtable
{
public:
...
private:
    ...
    friend class __my_hashtable_iterator<Value, Key, Value&, Value*, HashFun, ExtractKey, EqualKey, Alloc>;
    friend class __my_hashtable_iterator<Value, Key, const Value&, const Value*, HashFun, ExtractKey, EqualKey, Alloc>;
public:
    typedef __my_hashtable_iterator<Value, Key, Value&, Value*, HashFun, ExtractKey, EqualKey, 										Alloc> iterator;
    typedef __my_hashtable_iterator<Value, Key, const Value&, const Value*, HashFun, ExtractKey, EqualKey, 								Alloc>	const_iterator;
...
public:
    my_hashtable(size_type n, const HashFun& hf, const EqualKey& eql) : hash(hf), equals(eql), get_key(ExtractKey()), 											num_elements(0)
    {
...
private:
    ...
    size_type next_size(unsigned long n) const
    {
        return __my_stl_next_prime(n);
    }
public:
    //find the max size of prime
    size_type max_bucket_count() const
    {
        return __my_stl_prime_list[__my_stl_num_primes - 1];
    }
...
my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::find_or_insert(const value_type& obj)
{
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
inline void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::erase(iterator position)
{
    if (position == end())
    {
        return;
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
inline void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::erase(const_iterator position)
{
    if (position == end())
    {
        return;
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
inline void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::erase(iterator first, iterator last)
{
    if (first == last)
    {
        return;
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
inline void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::erase(const_iterator first,
        const_iterator last)
{
    if (first == last)
    {
...
******/
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::resize(size_type num_elements_hint)
{
...
my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::insert_unique_noresize(const value_type& obj)
{
...
my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::insert_equal_noresize(const value_type& obj)
{
    const size_type n = bkt_num(obj);
    node* first = buckets[n];
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
void my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::copy_from(const my_hashtable& ht)
{
    buckets.clear();
...
my_pair<typename my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::const_iterator,
        ...
        my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::equal_range(const key_type& key) const
{
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
typename my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::const_iterator
my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::lower_bound(const key_type& key) const
{
    if (empty())
    {
        return iterator((node*) 0, this);
...
template <class Value, class Key, class HashFun, class ExtractKey, class EqualKey, class Alloc>
typename my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::const_iterator
my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::upper_bound(const key_type& key) const
{
    if (empty())
    {
        return const_iterator((node*) 0, const_cast<hashtable*>(this));
                 ...
                 const my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>& y)
{
    if (x.size() == y.size())
    {
        typedef typename my_hashtable<Value, Key, HashFun, ExtractKey, EqualKey, Alloc>::const_iterator 												const_iterator;
