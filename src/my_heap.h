...
inline void __my_push_heap_aux(RandomAccessIterator first, RandomAccessIterator last,
                               Distance*, T*)
{
...
// make the root value in the last position of the container, and sort the containter to be just like
// a heap except the last which is the root value
template <class RandomAccessIterator>
...
template <class RandomAccessIterator, class Distance, class T>
void __my_adjust_heap(RandomAccessIterator first, Distance holeIndex, Distance len, T value)
{
...
// make the container be a heap, the heap here is just like a algorhtim, and its function is making the
// value in the container be in a type that the parent's value is bigger than the children's value
template <class RandomAccessIterator>
