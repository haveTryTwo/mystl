...
inline typename my_iterator_traits<InputIterator> ::difference_type
__my_distance(InputIterator first, InputIterator last, my_input_iterator_tag)
{
...
inline typename my_iterator_traits<RandomAccessIterator> ::difference_type
__my_distance(RandomAccessIterator first, RandomAccessIterator last, my_random_access_iterator_tag)
{
    return last - first;
}
...
template <class InputIterator>
inline typename my_iterator_traits<InputIterator> ::difference_type
my_distance(InputIterator first, InputIterator last)
{
...
***************************************************/
template <class Container>
class my_front_insert_iterator : public my_iterator<my_output_iterator_tag, void, void, void, void>
{
protected:
    Container* container;
...
public:
    ...
    my_front_insert_iterator<Container> operator++(int)
    {
        return *this;
    }
};
...
public:
    explicit my_insert_iterator(Container& x, typename Container::iterator it) : container(&x), iter(it) {}
...
template <class Iterator>
typename my_reverse_iterator<Iterator>::difference_type
operator- (const my_reverse_iterator<Iterator>& x,
