...
public:
    my_binder1st(const Operation& x, const typename Operation::first_argument_type&  y) : op(x), value(y) {}
...
public:
    my_binder2nd(const Operation& x, const typename Operation::second_argument_type& y) : op(x), value(y) {}
...
template <class Operation1, class Operation2>
inline my_unary_compose<Operation1, Operation2>
my_compose1(const Operation1& op1, const Operation2& op2)
{
...
public:
    my_binary_compose(const Operation1& x, const Operation2& y, const Operation3& z) : op1(x), op2(y), op3(z) {}
