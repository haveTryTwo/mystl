#ifndef MY_STREAM_ITERATOR_H
#define MY_STREAM_ITERATOR_H
...
public:
    ...
    my_istream_iterator(istream& s) : stream(&s)
    {
        read();
    }
...
public:
    ...
    my_ostream_iterator<T>& operator*()
    {
        return *this;
    }
    ...
    my_ostream_iterator<T> operator++(int)
    {
        return *this;
    }
};
