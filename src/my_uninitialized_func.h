#ifndef MY_UNINITIALIZED_FUNC_H
#define MY_UNINITIALIZED_FUNC_H
...
template <class ForwardIterator, class Size, class T>
inline ForwardIterator __my_uninitialized_fill_n_aux(ForwardIterator first, Size n, const T& x, __my_true_type)
{
    return my_fill_n(first, n, x);
}

template <class ForwardIterator, class Size, class T>
inline ForwardIterator __my_uninitialized_fill_n_aux(ForwardIterator first, Size n, const T& x, __my_false_type)
{
...
template <class ForwardIterator, class T>
inline void __my_uninitialized_fill_aux(ForwardIterator first, ForwardIterator last, const T& x, __my_true_type)
{
    my_fill(first, last, x);
}

template <class ForwardIterator, class T>
inline void __my_uninitialized_fill_aux(ForwardIterator first, ForwardIterator last, const T& x, __my_false_type)
{
    ForwardIterator cur = first;
    for(; cur != last; ++cur)
    {
...
inline ForwardIterator my_uninitialized_copy(InputIterator first, InputIterator last, ForwardIterator result)
{
...
inline ForwardIterator __my_uninitialized_copy(InputIterator first, InputIterator last, ForwardIterator result, T*)
{
...
template <class InputIterator, class ForwardIterator>
inline ForwardIterator __my_uninitialized_copy_aux(InputIterator first, InputIterator last, ForwardIterator result, 							__my_true_type)
{
    return my_copy(first, last, result);
}

template <class InputIterator, class ForwardIterator>
inline ForwardIterator __my_uninitialized_copy_aux(InputIterator first, InputIterator last, ForwardIterator result, 							__my_false_type)
{
